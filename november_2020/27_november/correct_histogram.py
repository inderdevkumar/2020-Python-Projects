...
def load_csv(filepath): #loads a csv file
...
if __name__ == "__main__":
    ...
    while True:
      ...
      # loop untill user enters right value
      while True:
        try:
          option = int(input())
          if option>3:
      ...
      if option ==1:
        ...
        # asks the users for columns refer to chr and ord from https://www.geeksforgeeks.org/ways-increment-character-python/ to know about indexing using alphabets
        while True:
      ...
      if option ==3:
        try:
          ...
          print("*************** Thanks for using the Data Analysis App**********.The histogram of the column will be displayed")
